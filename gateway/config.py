...
MAX_PORTFOLIO_RISK = 2.0 * RISK_UNIT          # суммарно на столе — не больше 2R
...
# Непроверенный сетап торгуется четвертью единицы риска. Проверенный —
# полной. Разница в размере и есть цена незнания.
PROBATION_RISK_FRACTION = 0.25
